...
-   Улучшение ремонтной нано-системы теперь дает командному боту поддержки Серафим правильное количество очков прочности (14к вместо 45к);
![sera_scu.png](/images/learning/sera/sera_scu.png)
-   Командного бота поддержки Серафим больше нельзя утилизировать;
![sera_scu.png](/images/learning/sera/sera_scu.png)![reclaim_icon.png](/images/learning/reclaim_icon.png)
-   Ядерная ракета Т3 линкора Серафим "Хаутуум" больше не летает на слишком большой высоте;
![sera_t3_battleship.png](/images/learning/sera/sera_t3_battleship.png)
-   Здоровье ракет Кибран нормализовано, у родительской и дочерних ракет теперь по 1 единице здоровья;
