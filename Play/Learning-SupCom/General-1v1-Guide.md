...
After a while you will get some Mass from your newly built mexes, and you will have a couple Engineers in your base waiting to use it. The best thing to spend your newly gained Mass on at this point would be extra Land Factories.  
Be aware, as you spend more and more Mass, you will need more and more Energy. You should be generally okay if you build 1 pgen for every Land Factory you build from this point on. For each Air Factory you will need 4 adjacent pgens. You should also begin building a row of pgens at the back of your base with 1 or 2 Engineers, these will satisfy your new Engineers building things, various upgrades, etc.

Sooner or later you will be spending more Mass than you are gaining, at that point you will need to manage your economy. You can either pause or cancel projects, depending on your preference. The first thing to pause would be the engineers building pgens (assuming you aren't stalling power).
If you are still stalling Mass after pausing pgen production, pause Engineers building factories and if you are still stalling a lot of Mass, pause some of the factories. You can unpause them once you get more Mass.
...
If you wish to be aggressive very early on, you can make some Light Assault Bots (LABs). If you use LABs, make them somewhere in your first 5 units. They are considerably worse than tanks so they can mainly kill engineers without an escort. Consider pairing them with Scouts to find enemy Engineers more easily.
...
Reclaim can be seen when holding down Ctrl and Shift and gives a brief Mass boost. Two types of reclaim exist. The type that is there when you spawn, and that which is created when units and buildings are killed (wreckage).
Natural reclaim consists usually of a few big rocks and from a large amount of small rocks spread around. Sometimes there are some wrecks near the middle of the map. You can boost your early Mass (you are able to build more in your base before you leave) with reclaim that is close to your base.
...
Scouts, Radar and Sonar provide all of your intel. Scouts in your armies allow you to get more vision on the area you are moving to. This gives you some extra time to retreat from a larger army or from a PD before taking significant losses.
...
Do you see a raid coming? Move units to defend.
Is your opponent getting T2 land or navy? Get your own if you can't prevent him from getting it.
Is opponent ecoing a lot? See if you can't raid one of his expansions.
...
Most naval maps are 20x20 and require a transport rush (see [this video](https://youtu.be/_6uE1-xS2uk?t=7m40s)). Usually there are multiple islands/land masses that must be dropped to get the mexes in a timely manner.

After or during your expansion with transport(s), you will build some Naval Factories. Early production of Frigates can raid your opponent's mexes that are on the very edge of their island(s) and raid their Engineers building Naval Factories if they get them up too late.

Once you have a bit of T1 navy and your expansions are secure, you should get T2 navy. Destroyers are able to shell your opponent's navy from afar and they can also kill mexes that your Frigates can't reach. Often the player who has the most Destroyers will win the naval game. This requires a good economy (you need to make some T2 mexes sooner or later) and ample build power on your T2 Naval Factory (Engineers).

You must not forget Frigates though, as a Destroyer requires an escort of Frigates. The Destroyer's main power comes from its weapon's range and if many enemy frigates get close, the Destroyer will die quickly. A mix of Destroyers and Frigates is needed. Torpedo Bombers can also be used to kill Destroyers, allowing you to swing the game in your favour.

UEF players should: 
1. Build some Shield Boats once they get T2 navy, it will increase the survivability of Naval units.
2. Also consider getting T3 navy and Battlecruisers, once they have enough Mass income and time to upgrade the Naval Factory.

A note on submarines - While they are reasonable against Frigates, they are bad at raiding shore mexes (bad deck gun, have to surface) and have very low damage, which can allow your opponent to wreak havoc on your Naval Factories with a Frigate before your subs can kill it.
Destroyers from all factions also have torpedoes, that will quickly deal even with large Submarine groups (UEF has the Torpedo Boat for this purpose).

Get T3 Sonar once you can build T2 pgens. Playing as Seraphim faction you have to build T2 Sonars around the map.

## General strategy/tactics/approach tips
- Before commiting to an offensive,  evaluate if the attack is more than likely to be a success, or else the reclaim left will only feed your opponent.
...
- Don't "learn" maps, instead learn the game. A good player with deep game understanding will do great on any map, a player that focuses on map learning won't improve or adapt nearly as fast.
- play to your chosen faction's advantages. You will learn about them as you get more familiar with the game but a lot of them are already in different guides, including the ones linked above.
- Don't overcommit with the ACU. Even though not using your ACU for its firepower might seem like wasted potential, in many cases it's too dangerous to use it aggressively. Experience and good use of intel will help determine when to commit the ACU in aggression.
- Build power is also a resource, sometimes killing a group of enemy Engineers can have more impact in a match than raiding opposing mexes.

## How do I improve?
- You won't improve fast just by playing a lot. You have to learn the mechanics first. You should have them covered by now, if not - read [Beginner's Guide to Forged Alliance Forever](https://wiki.faforever.com/en/Play/Learning/Beginners-Guide-to-Forged-Alliance), and play a couple games to get a feel for the game. Next step would be to read this guide.
- After every game go and watch it's replay, see what caused you to lose and be honest with yourself. Watch replays of people \~300 rating above yourself, I would say it's the best range to learn from. Those players are clearly better but also don't have a massive difference from your gameplay so it's easy to pick up things from their games. You can also watch replays of high level 1v1s, but picking things up from them will be quite difficult, but they are often a good source of build orders.
