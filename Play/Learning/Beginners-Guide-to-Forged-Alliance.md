...
- Pros:
  - T1 Assault Bot is the Cybran's T1 Tank, which moves faster than other T1 tanks. It can even assist with building, though it's ability to build things is far worse than an Engineers so they should be used for this purpose in a pinch
