...
ACU enhancements serve as upgrades to keep your ACU relevant as a match progresses by augmenting its capabilities based on which enhancements the player chooses.
...
Applying an enhancement to ACU renders it immobile, putting it out of action.
Like upgrades at Mass Extractors and Factories, ACU Enhancements can be paused or cancelled, though a paused ACU is also immobile.
...
Enables ACU to construct T3 buildings and Experimental units.
...
Increase Mass and Energy per secound production of ACU
...
Further increases Mass and Energy per secound production of ACU
