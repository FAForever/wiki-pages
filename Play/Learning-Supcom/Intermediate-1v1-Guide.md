...
- For most ladder maps, the "gun" upgrade is almost essential. The gun upgrade is self explanatory, but for convenience they are the following
	1. UEF: Zephyr Amplifier (Damage & Range)
  2. Aeon: Enhanced Quantum Disruptor (Range), Quantum Accelerator (Speed), Advanced Quantum Disruptor LCH (Advanced Range)
