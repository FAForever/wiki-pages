...
AI Variants: Easy, Adaptive, Air, Land, Rush, Tech, Turtle, Navy, Random.  Adaptive is suggested as the more competitive of these variants.
...
This tournament featured 2 teams of 4 human players fighting each other, with AI featuring in a variety of ways, sometimes as a teammate (similarly to Rainbow Cup VII), and sometimes as enemy team(s).
