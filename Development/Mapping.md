...
| **MidRgbColor** | Legacy parameter. Changing this value doesnt change any outcome. |
...
FAF provides additional terrain shaders. These alter how the game renders the map and provide opportunity to improve the visual fidelity of the map, for example by adding proper terrain shadows. You can find in-depth explanations of all available shaders [here](/Development/Shaders/terrain-shaders).
